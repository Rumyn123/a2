 ...
 * @author Rumyn
 */
public class Univ extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tabla_unidad.setFont(new java.awt.Font("Bookman Old Style", 1, 14)); // NOI18N
    ...
    private void btn_ModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ModificarActionPerformed
        ...
        String id;
        DefaultTableModel dt = (DefaultTableModel) tabla_unidad.getModel();
        try{
            if(tabla_unidad.getSelectedRow() != (-1)){
                id = dt.getValueAt(tabla_unidad.getSelectedRow(), 0).toString();

                if (id != null){
                    Univ_m pre = new Univ_m(id);
                    pre.show(); 
                } else {
                    Metodos.mensaje("Actualice primero la tabla y seleccione una unidad");
                }
            } else {
                Metodos.mensaje("Selecciona una unidad primero");
            }
    ...
    private void actualizarTabla(){
        ...
        v.visualizar(tabla_unidad,"Univ");
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Univ.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
